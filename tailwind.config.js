...
export default {
    ...
    theme: {
        ...
        extend: {
            fontFamily: {
                sans: ['Noto Sans Arabic', 'Noto Color Emoji', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', 'sans-serif'],
            },
            colors: {
